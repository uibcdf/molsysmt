...
class TQDMReporter(object):
    ...
    def finalize(self, state):
        ...
        nanoseconds_md = (self._end_md_time - self._start_md_time).in_units_of(
            unit.nanoseconds
        )
        ...
        print("")
        print(
            f"Execution time: {days} days, {hours} hours, {minutes} minutes, and {seconds} seconds ({nanoseconds_per_hour} ns/day)."
        )
        print("")
