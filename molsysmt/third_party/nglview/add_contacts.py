...
def add_contacts(
    ...
    add_cylinders(
        ...
        mid_color_value=mid_color_value,
        max_color_value=max_color_value,
        color_values_scale=color_values_scale,
        colormap=colormap,
        color_values_2=color_values_2,
        min_color_value_2=min_color_value_2,
        mid_color_value_2=mid_color_value_2,
        max_color_value_2=max_color_value_2,
        color_values_scale_2=color_values_scale_2,
        colormap_2=colormap_2,
        skip_digestion=False,
    )
