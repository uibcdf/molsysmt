...
try:
    ...
    print(
        "The file molsysmt.data.databases.terminal_cappings.c_terminal.json was not loaded."
    )
...
try:
    ...
    print(
        "The file molsysmt.data.databases.terminal_cappings.n_terminal.json was not loaded."
    )
