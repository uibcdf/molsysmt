...
def get_entity_name(
    ...
    if redefine_indices or redefine_names:
        from ..molecule import get_molecule_index, get_molecule_name, get_molecule_type
        ...
        molecule_index_from_atoms = get_molecule_index(
            molecular_system,
            element="atom",
            selection=selection,
            redefine_indices=redefine_indices,
        ...
        molecule_name_from_molecules = get_molecule_name(
            molecular_system,
            element="molecule",
            selection="all",
            redefine_indices=redefine_indices,
        ...
        molecule_type_from_molecules = get_molecule_type(
            molecular_system,
            element="molecule",
            selection="all",
            redefine_indices=redefine_indices,
        ...
        for molecule_name, molecule_type in zip(
            molecule_name_from_molecules, molecule_type_from_molecules
        ):
        ...
        match element:
            case "atom":
                output = [
                    entity_names[molecule_to_entity[ii]]
                    for ii in molecule_index_from_atoms
                ]
            case "molecule":
