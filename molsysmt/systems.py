...
systems["alanine dipeptide"]["alanine_dipeptide.h5msm"] = path(
    "molsysmt.data.h5msm", "alanine_dipeptide.h5msm"
)

systems["proline dipeptide"] = {}
systems["proline dipeptide"]["proline_dipeptide.h5msm"] = path(
    "molsysmt.data.h5msm", "proline_dipeptide.h5msm"
)

systems["valine dipeptide"] = {}
systems["valine dipeptide"]["valine_dipeptide.h5msm"] = path(
    "molsysmt.data.h5msm", "valine_dipeptide.h5msm"
)

systems["lysine dipeptide"] = {}
systems["lysine dipeptide"]["lysine_dipeptide.h5msm"] = path(
    "molsysmt.data.h5msm", "lysine_dipeptide.h5msm"
)

systems["pentalanine"] = {}
systems["pentalanine"]["pentalanine.inpcrd"] = path(
    "molsysmt.data.inpcrd", "pentalanine.inpcrd"
)
systems["pentalanine"]["pentalanine.prmtop"] = path(
    "molsysmt.data.prmtop", "pentalanine.prmtop"
)
systems["pentalanine"]["traj_pentalanine.h5"] = path(
    "molsysmt.data.h5", "traj_pentalanine.h5"
)
systems["pentalanine"]["traj_pentalanine.h5msm"] = path(
    "molsysmt.data.h5msm", "traj_pentalanine.h5msm"
)

systems["Met-enkephalin"] = {}
systems["Met-enkephalin"]["met_enkephalin.pdb"] = path(
    "molsysmt.data.pdb", "met_enkephalin.pdb"
)
systems["Met-enkephalin"]["met_enkephalin.h5msm"] = path(
    "molsysmt.data.h5msm", "met_enkephalin.h5msm"
)
...
systems["chicken villin HP35"]["1vii.bcif.gz"] = path(
    "molsysmt.data.bcif_gz", "1vii.bcif.gz"
)
systems["chicken villin HP35"]["1vii.bcif"] = path("molsysmt.data.bcif", "1vii.bcif")
systems["chicken villin HP35"]["chicken_villin_HP35.h5msm"] = path(
    "molsysmt.data.h5msm", "chicken_villin_HP35.h5msm"
)
systems["chicken villin HP35"]["chicken_villin_HP35_solvated.h5msm"] = path(
    "molsysmt.data.h5msm", "chicken_villin_HP35_solvated.h5msm"
)
systems["chicken villin HP35"]["traj_chicken_villin_HP35_solvated.dcd"] = path(
    "molsysmt.data.dcd", "traj_chicken_villin_HP35_solvated.dcd"
)
systems["chicken villin HP35"]["traj_chicken_villin_HP35_solvated.h5"] = path(
    "molsysmt.data.h5", "traj_chicken_villin_HP35_solvated.h5"
)
systems["chicken villin HP35"]["traj_chicken_villin_HP35_solvated.h5msm"] = path(
    "molsysmt.data.h5msm", "traj_chicken_villin_HP35_solvated.h5msm"
)

systems["T4 lysozyme L99A"] = {}
systems["T4 lysozyme L99A"]["181l.pdb"] = path("molsysmt.data.pdb", "181l.pdb")
systems["T4 lysozyme L99A"]["181l.bcif.gz"] = path(
    "molsysmt.data.bcif_gz", "181l.bcif.gz"
)
...
systems["T4 lysozyme L99A"]["t4_lysozyme_L99A.h5msm"] = path(
    "molsysmt.data.h5msm", "t4_lysozyme_L99A.h5msm"
)
...
systems["Barnase-Barstar"]["barnase_barstar.h5msm"] = path(
    "molsysmt.data.h5msm", "barnase_barstar.h5msm"
)
systems["Barnase-Barstar"]["1brs.bcif"] = path("molsysmt.data.bcif", "1brs.bcif")
systems["Barnase-Barstar"]["1brs.bcif.gz"] = path(
    "molsysmt.data.bcif_gz", "1brs.bcif.gz"
)
...
systems["POPC membrane"]["popc_membrane.psf"] = path(
    "molsysmt.data.psf", "popc_membrane.psf"
)
systems["POPC membrane"]["popc_membrane.dcd"] = path(
    "molsysmt.data.dcd", "popc_membrane.dcd"
)
...
systems["two LJ particles"]["traj_two_lj_particles.trjpk"] = path(
    "molsysmt.data.trjpk", "traj_two_lj_particles.trjpk"
)

systems["particles 4"] = {}
systems["particles 4"]["traj_particles_4.xyznpy"] = path(
    "molsysmt.data.xyznpy", "traj_particles_4.xyznpy"
)
...
systems.info = {
    ...
    "benzamidine": {
        ...
        "files": {"benzamidine.pdb": "PDB format structure file for benzamidine."},
    },
    "caffeine": {
