...
def remove_overlapping_molecules(
    ...
    from molsysmt import get, remove, select
    ...
    molecules_to_be_removed = get(
        molecular_system,
        element="atom",
        selection=atoms_to_be_removed,
        molecule_index=True,
    )
    molecules_to_be_removed = np.unique(molecules_to_be_removed)
    atoms_to_be_removed = select(
        molecular_system, selection="molecule_index==@molecules_to_be_removed"
    )
