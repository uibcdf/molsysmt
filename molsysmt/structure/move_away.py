...
def move_away(
    molecular_system,
    selection="all",
    center_of_selection="all",
    weights=None,
    structure_indices=0,
    reference_molecular_system=None,
    reference_center_of_selection="all",
    reference_weights=None,
    reference_structure_indices=None,
    direction=None,
    distance="3 angstroms",
    in_place=False,
    syntax="MolSysMT",
    ...
    * **Explicit direction**: the selection is first centered on the reference
    ...
    from molsysmt.structure import center, get_center
    ...
    coordinates_reference_center = get_center(
        reference_molecular_system,
        selection=reference_center_of_selection,
