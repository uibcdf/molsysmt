...
def to_MDAnalysis_Topology(
    ...
    if atom_indices != "all":
        from molsysmt.form.MDAnalysis_Topology.extract import (
            extract as extract_MDAnalysis_Topology,
        )

        tmp_item = extract_MDAnalysis_Topology(
