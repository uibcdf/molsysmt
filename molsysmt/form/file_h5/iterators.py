...
from ..mdtraj_HDF5TrajectoryFile.iterators import (
    StructuresIterator as StructuresIterator_HDF5TrajectoryFile,
)
from ..mdtraj_HDF5TrajectoryFile.iterators import (
    TopologyIterator as TopologyIterator_HDF5TrajectoryFile,
)
