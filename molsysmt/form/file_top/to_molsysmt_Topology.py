...
def to_molsysmt_Topology(
    ...
    from molsysmt.form.parmed_GromacsTopologyFile.to_molsysmt_Topology import (
        to_molsysmt_Topology as parmed_GromacsTopologyFile_to_molsysmt_Topology,
    )
    ...
    tmp_item = parmed_GromacsTopologyFile_to_molsysmt_Topology(
