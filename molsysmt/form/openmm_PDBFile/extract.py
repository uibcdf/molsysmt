...
def extract(
    ...
    if is_all(atom_indices) and is_all(structure_indices):
        ...
        from molsysmt.form.openmm_Topology.to_openmm_PDBFile import (
            to_openmm_PDBFile as openmm_Topology_to_openmm_PDBFile,
        )
        ...
        tmp_item = openmm_Topology_to_openmm_PDBFile(
