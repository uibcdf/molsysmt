...
def to_molsysmt_MolSys(
    ...
    from molsysmt.form.parmed_Structure.to_molsysmt_MolSys import (
        to_molsysmt_MolSys as parmed_Structure_to_molsysmt_MolSys,
    )

    return parmed_Structure_to_molsysmt_MolSys(
        item,
