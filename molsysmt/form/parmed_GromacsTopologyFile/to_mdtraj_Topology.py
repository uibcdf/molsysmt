...
def to_mdtraj_Topology(item, atom_indices="all", skip_digestion=False):
    ...
    from molsysmt.form.parmed_Structure.to_mdtraj_Topology import (
        to_mdtraj_Topology as parmed_Structure_to_mdtraj_Topology,
    )

    return parmed_Structure_to_mdtraj_Topology(
