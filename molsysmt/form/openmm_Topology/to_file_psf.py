...
def to_file_psf(item, atom_indices='all', output_filename=None, skip_digestion=False):
    ...
    from molsysmt.form.parmed_Structure import to_parmed_Structure as openmm_Topology_to_parmed_Structure
    from molsysmt.form.parmed_Structure import to_file_psf as openmm_Structure_to_file_psf
