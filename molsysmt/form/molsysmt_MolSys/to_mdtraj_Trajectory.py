...
def to_mdtraj_Trajectory(
    ...
    tmp_item_topology = to_mdtraj_Topology(
        item, atom_indices="all", skip_digestion=True
    )

    tmp_box_lengths = get_box_lengths_from_system(
        item, structure_indices="all", skip_digestion=True
    )
    ...
    tmp_coordinates = get_coordinates_from_atom(
        item, indices="all", structure_indices="all", skip_digestion=True
    )
