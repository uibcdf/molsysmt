...
def to_molsysmt_MolecularMechanicsDict(item, atom_indices='all', skip_digestion=False):
    ...
    from ..molsysmt_MolecularMechanics.to_molsysmt_MolecularMechanicsDict import to_molsysmt_MolecularMechanicsDict as molsysmt_MolecularMechanics_to_MolecularMechanicsDict
