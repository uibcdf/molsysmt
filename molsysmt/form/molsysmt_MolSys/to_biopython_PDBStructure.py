...
def to_biopython_PDBStructure(
    item, atom_indices="all", structure_indices="all", skip_digestion=False
):
    """
    Converting from molsysmt.MolSys to biopython.PDBStructure.
    ...
    atom_names, atom_ids, elements = get(
        item, element="atom", selection=atom_indices, name=True, id=True, type=True
    )
