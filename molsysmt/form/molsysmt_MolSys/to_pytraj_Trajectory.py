...
def to_pytraj_Trajectory(item, atom_indices='all', structure_indices='all', skip_digestion=False):
    ...
    from molsysmt.form.pytraj_Topology import to_pytraj_Topology
    from molsysmt.form.pytraj_Topology import to_pytraj_Trajectory as pytraj_Topology_to_pytraj_Trajectory
