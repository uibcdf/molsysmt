...
def to_biopython_Seq(item, group_indices='all', skip_digestion=False):
    ...
    from ..string_amino_acids_1.to_string_amino_acids_1 import to_string_amino_acids_1
    from ..string_amino_acids_1.to_biopython_Seq import to_biopython_Seq as string_amino_acids_1_to_biopython_Seq
