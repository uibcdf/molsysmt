...
def to_parmed_Structure(item, atom_indices='all', skip_digestion=False):
    ...
    from ..molsysmt_Topology.to_molsysmt_Topology import to_molsysmt_Topology as molsysmt_MolSys_to_molsysmt_Topology
    from ..molsysmt_Topology.to_parmed_Structure import to_parmed_Structure as molsysmt_Topology_to_parmed_Structure
