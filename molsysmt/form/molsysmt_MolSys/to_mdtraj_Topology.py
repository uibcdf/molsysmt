...
def to_mdtraj_Topology(item, atom_indices="all", skip_digestion=False):
    ...
    from molsysmt.form.molsysmt_Topology.to_mdtraj_Topology import (
        to_mdtraj_Topology as molsysmt_Topology_to_mdtraj_Topology,
    )

    from .to_molsysmt_Topology import to_molsysmt_Topology

    tmp_item = to_molsysmt_Topology(item, skip_digestion=True)
    tmp_item = molsysmt_Topology_to_mdtraj_Topology(
