...
@dep_digest("mdtraj")
def to_mdtraj_DCDTrajectoryFile(
    ...
    from ..mdtraj_DCDTrajectoryFile.extract import (
        extract as extract_mdtraj_DCDTrajectoryFile,
    )
    ...
    tmp_item = extract_mdtraj_DCDTrajectoryFile(
        tmp_item,
