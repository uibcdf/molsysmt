...
def get_group_type_from_atom(
    ...
    if not is_all(indices):
        group_index_per_atom = group_index_per_atom[indices]
    return [
        get_group_type_from_group_name(group_names[i]) for i in group_index_per_atom
    ]
