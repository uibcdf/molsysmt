...
def to_molsysmt_Topology(item, atom_indices="all", skip_digestion=False):
    ...
    from molsysmt.form.file_fasta.to_molsysmt_Topology import (
        to_molsysmt_Topology as file_fasta_to_molsysmt_Topology,
    )

    from .to_file_fasta import to_file_fasta

    tmp_item = to_file_fasta(item, skip_digestion=True)
    tmp_item = file_fasta_to_molsysmt_Topology(
