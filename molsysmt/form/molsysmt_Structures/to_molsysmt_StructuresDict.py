...
def to_molsysmt_StructuresDict(
    ...
    velocities = (
        ...
        if getattr(item, "velocities", None) is not None
        else None
    )
    b_factor = (
        get_b_factor_from_atom(
        ...
        if getattr(item, "b_factor", None) is not None
        else None
    )
    occupancy = (
        get_occupancy_from_atom(
        ...
        if getattr(item, "occupancy", None) is not None
        else None
    )
    alternate_location = (
        get_alternate_location_from_atom(
