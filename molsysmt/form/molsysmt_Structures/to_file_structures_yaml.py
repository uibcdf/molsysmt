...
def to_file_structures_yaml(
    ...
    from molsysmt.form.molsysmt_StructuresDict.to_file_structures_yaml import (
        to_file_structures_yaml as _to_file,
    )

    from .to_molsysmt_StructuresDict import to_molsysmt_StructuresDict

    tmp_item = to_molsysmt_StructuresDict(
        item,
