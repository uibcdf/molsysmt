...
def to_file_top(item, atom_indices='all', output_filename=None, skip_digestion=False):
    ...
    from ..parmed_GromacsTopologyFile.to_parmed_GromacsTopologyFile import to_parmed_GromacsTopologyFile
    from ..parmed_GromacsTopologyFile.to_file_top import to_file_top as parmed_GromacsTopologyFile_to_file_top
