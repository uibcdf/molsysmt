...
def to_parmed_GromacsTopologyFile(item, atom_indices='all', skip_digestion=False):
    ...
    from ..parmed_Structure.to_parmed_Structure import to_parmed_Structure
    from ..parmed_Structure.to_parmed_GromacsTopologyFile import to_parmed_GromacsTopologyFile as parmed_Structure_to_parmed_GromacsTopologyFile
