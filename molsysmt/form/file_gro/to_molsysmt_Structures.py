...
def to_molsysmt_Structures(
    ...
    from molsysmt.form.molsysmt_GROFileHandler.to_molsysmt_Structures import (
        to_molsysmt_Structures as molsysmt_GROFileHandler_to_molsysmt_Structures,
    )
    ...
    tmp_item = molsysmt_GROFileHandler_to_molsysmt_Structures(
        tmp_item,
