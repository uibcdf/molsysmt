...
def has_attribute(
    ...
    .. versionadded:: 1.0.0
    """
    from molsysmt.form.molsysmt_TopologyDict.has_attribute import (
        has_attribute as dict_has_attribute,
    )
    ...
    return dict_has_attribute(
        item, attribute=attribute, include_none=include_none, skip_digestion=True
    )
