...
def to_openmm_Modeller(
    ...
    from molsysmt.form.openmm_PDBFile.to_openmm_Modeller import (
        to_openmm_Modeller as openmm_PDBFile_to_openmm_Modeller,
    )

    from .to_openmm_PDBFile import to_openmm_PDBFile

    tmp_item = to_openmm_PDBFile(item, skip_digestion=True)
    tmp_item = openmm_PDBFile_to_openmm_Modeller(
        tmp_item,
