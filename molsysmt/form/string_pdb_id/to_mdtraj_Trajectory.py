...
def to_mdtraj_Trajectory(
    ...
    """
    Converting from string:pdb_id to mdtraj.Trajectory.
    ...
    from molsysmt.form.molsysmt_MolSys.to_mdtraj_Trajectory import (
        to_mdtraj_Trajectory as molsysmt_MolSys_to_mdtraj_Trajectory,
    )
