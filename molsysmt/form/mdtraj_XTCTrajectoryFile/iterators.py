...
class StructuresIterator:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._mdtraj_atom_indices = (
            None if is_all(self.atom_indices) else self.atom_indices
        )
    ...
    def __next__(self):
        ...
        if indices is not None:
            ...
            for ii in idx_array:
                ...
                xyz, time, step, box = self.molecular_system.read(
                    1, atom_indices=self._mdtraj_atom_indices
                )
