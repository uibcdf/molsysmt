...
def to_nglview_NGLWidget(
    ...
    from molsysmt.form.molsysmt_H5MSMFileHandler.to_nglview_NGLWidget import (
        to_nglview_NGLWidget as molsysmt_H5MSMFileHandler_to_nglview_NGLWidget,
    )

    handler = to_molsysmt_H5MSMFileHandler(item, skip_digestion=True)
    tmp_item = molsysmt_H5MSMFileHandler_to_nglview_NGLWidget(
        handler,
