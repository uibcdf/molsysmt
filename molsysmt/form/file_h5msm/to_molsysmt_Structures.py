...
def to_molsysmt_Structures(
    ...
    from molsysmt.form.molsysmt_H5MSMFileHandler.to_molsysmt_Structures import (
        to_molsysmt_Structures as molsysmt_H5MSMFileHandler_to_molsysmt_Structures,
    )

    handler = to_molsysmt_H5MSMFileHandler(item, skip_digestion=True)
    tmp_item = molsysmt_H5MSMFileHandler_to_molsysmt_Structures(
        handler,
