...
def to_molsysmt_Topology(
    ...
    from molsysmt.form.file_prmtop.to_openmm_AmberPrmtopFile import (
        to_openmm_AmberPrmtopFile as file_prmtop_to_openmm_AmberPrmtopFile,
    )
    from molsysmt.form.openmm_AmberPrmtopFile.to_molsysmt_Topology import (
        to_molsysmt_Topology as openmm_AmberPrmtopFile_to_molsysmt_Topology,
    )
    ...
    tmp_item = openmm_AmberPrmtopFile_to_molsysmt_Topology(
