...
def to_openmm_Topology(item, atom_indices="all", skip_digestion=False):
    ...
    from molsysmt.form.openmm_AmberPrmtopFile.to_openmm_Topology import (
        to_openmm_Topology as openmm_AmberPrmtopFile_to_openmm_Topology,
    )
    ...
    tmp_item = openmm_AmberPrmtopFile_to_openmm_Topology(
