...
def get_n_groups_from_system(item, skip_digestion=False):
    ...
    raise NotWithThisFormError(
        caller="molsysmt.form.mdtraj_PDBTrajectoryFile.get_n_groups_from_system",
        form=form,
        requested_attribute="n_groups",
        message="This form does not expose group-level topology directly. Please convert to a topology-enabled form first.",
    )
