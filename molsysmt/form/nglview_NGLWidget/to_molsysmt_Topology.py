...
def to_molsysmt_Topology(
    item, atom_indices="all", get_missing_bonds=True, skip_digestion=False
):
    """
    Converting from nglview.NGLWidget to molsysmt.Topology.
    ...
    from molsysmt.form.string_pdb_text.to_molsysmt_Topology import (
        to_molsysmt_Topology as string_pdb_text_to_molsysmt_Topology,
    )
    ...
    tmp_topology = string_pdb_text_to_molsysmt_Topology(
        tmp_item_pdb, get_missing_bonds=False, skip_digestion=True
    )
