...
def extract(
    ...
    if is_all(atom_indices) and is_all(structure_indices):
        ...
        from molsysmt.form.nglview_NGLWidget.to_molsysmt_MolSys import (
            to_molsysmt_MolSys as nglview_NGLWidget_to_molsysmt_MolSys,
        )

        tmp_item = nglview_NGLWidget_to_molsysmt_MolSys(
            item,
