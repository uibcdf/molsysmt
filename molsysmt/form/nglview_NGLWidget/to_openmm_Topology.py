...
def to_openmm_Topology(
    ...
    """
    Converting from nglview.NGLWidget to openmm.Topology.
    ...
    from molsysmt.form.string_pdb_text.to_openmm_Topology import (
        to_openmm_Topology as string_pdb_text_to_openmm_Topology,
    )
