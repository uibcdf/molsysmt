...
def to_biopython_SeqRecord(item, atom_indices='all', skip_digestion=False):
    ...
    from ..string_aminoacids1.to_string_aminoacids1 import to_string_aminoacids1
    from ..string_aminoacids1.to_biopython_SeqRecord import to_biopython_SeqRecord as string_aminoacids1_to_biopython_SeqRecord
