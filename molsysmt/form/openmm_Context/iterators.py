...
from ..molsysmt_Structures.iterators import (
    StructuresIterator as StructuresIterator_molsysmt_Structures,
)
...
class StructuresIterator(StructuresIterator_molsysmt_Structures):
    ...
    def __init__(
        ...
        molecular_system = to_molsysmt_Structures(
            molecular_system, skip_digestion=False
        )
