...
def to_molsysmt_Structures(
    ...
    from molsysmt.form.file_inpcrd.to_openmm_AmberInpcrdFile import (
        to_openmm_AmberInpcrdFile as file_inpcrd_to_openmm_AmberInpcrdFile,
    )
    from molsysmt.form.openmm_AmberInpcrdFile.to_molsysmt_Structures import (
        to_molsysmt_Structures as openmm_AmberInpcrdFile_to_molsysmt_Structures,
    )
    ...
    tmp_item = openmm_AmberInpcrdFile_to_molsysmt_Structures(
        tmp_item,
