...
def get_coordinates_from_atom(item, indices='all', structure_indices='all', skip_digestion=False):
    ...
    from ..openmm_AmberInpcrdFile.get_coordinates_from_atom import get_coordinates_from_atom as aux_get
...
def get_velocities_from_atom(item, indices='all', structure_indices='all', skip_digestion=False):
    ...
    from ..openmm_AmberInpcrdFile.to_openmm_AmberInpcrdFile import to_openmm_AmberInpcrdFile
    from ..openmm_AmberInpcrdFile.get_velocities_from_atom import get_velocities_from_atom as aux_get
...
def get_n_atoms_from_system(item, skip_digestion=False):
    ...
    from ..openmm_AmberInpcrdFile.to_openmm_AmberInpcrdFile import to_openmm_AmberInpcrdFile
    from ..openmm_AmberInpcrdFile.get_n_atoms_from_system import get_n_atoms_from_system as aux_get
...
def get_n_structures_from_system(item, structure_indices='all', skip_digestion=False):
    ...
    from ..openmm_AmberInpcrdFile.to_openmm_AmberInpcrdFile import to_openmm_AmberInpcrdFile
    from ..openmm_AmberInpcrdFile.get_n_structures_from_system import get_n_structures_from_system as aux_get
...
def get_box_from_system(item, structure_indices='all', skip_digestion=False):
    ...
    from ..openmm_AmberInpcrdFile.to_openmm_AmberInpcrdFile import to_openmm_AmberInpcrdFile
    from ..openmm_AmberInpcrdFile.get_box_from_system import get_box_from_system as aux_get
...
def get_time_from_system(item, structure_indices='all', skip_digestion=False):
    ...
    from ..openmm_AmberInpcrdFile.to_openmm_AmberInpcrdFile import to_openmm_AmberInpcrdFile
    from ..openmm_AmberInpcrdFile.get_time_from_system import get_time_from_system as aux_get
...
def get_structure_id_from_system(item, structure_indices='all', skip_digestion=False):
    ...
    from ..openmm_AmberInpcrdFile.to_openmm_AmberInpcrdFile import to_openmm_AmberInpcrdFile
    from ..openmm_AmberInpcrdFile.get_structure_id_from_system import get_structure_id_from_system as aux_get
