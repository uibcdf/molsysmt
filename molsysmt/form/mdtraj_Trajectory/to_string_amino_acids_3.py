...
def to_string_amino_acids_3(item, atom_indices="all", skip_digestion=False):
    ...
    from molsysmt.form.mdtraj_Topology.to_string_amino_acids_3 import (
        to_string_amino_acids_3 as mdtraj_Topology_to_string_amino_acids_3,
    )

    tmp_item = to_mdtraj_Topology(item, skip_digestion=True)
    tmp_item = mdtraj_Topology_to_string_amino_acids_3(
