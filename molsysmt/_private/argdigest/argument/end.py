...
methods_where_none = ["molsysmt.third_party.nglview.add_arrows.add_arrows"]

methods_where_xyz = ["molsysmt.third_party.nglview.add_arrows.add_arrows"]

methods_where_can_be_selection = ["molsysmt.third_party.nglview.add_arrows.add_arrows"]
