...
def digest_structure_chemical_state_index(structure_chemical_state_index, caller=None):
    ...
    if (
        structure_chemical_state_index is None
        or structure_chemical_state_index is pd.NA
    ):
        return structure_chemical_state_index
