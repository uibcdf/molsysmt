def molsysmt_Topology_and_molsysmt_Structures_to_molsysmt_Topology(
    ...
    tmp_item = extract_topology(
        topology, atom_indices=atom_indices, copy_if_all=True, skip_digestion=True
    )

    return tmp_item


def molsysmt_Topology_and_molsysmt_StructuresDict_to_molsysmt_Topology(
    molecular_system, atom_indices="all", structure_indices="all", skip_digestion=False
):
...
def file_prmtop_and_file_inpcrd_to_molsysmt_Topology(
    molecular_system, atom_indices="all", structure_indices="all", skip_digestion=False
):
    ...
    tmp_item = file_prmtop_to_molsysmt_Topology(
...
def file_psf_and_file_dcd_to_molsysmt_Topology(
    molecular_system, atom_indices="all", structure_indices="all", skip_digestion=False
):
    ...
    tmp_item = file_psf_to_molsysmt_Topology(
...
def file_psf_and_file_crd_to_molsysmt_Topology(
    molecular_system, atom_indices="all", structure_indices="all", skip_digestion=False
):
...
def file_gro_and_file_xtc_to_molsysmt_Topology(
    molecular_system, atom_indices="all", structure_indices="all", skip_digestion=False
):
    ...
    tmp_item = file_gro_to_molsysmt_Topology(
        item_gro, atom_indices=atom_indices, get_missing_bonds=True, skip_digestion=True
    )

    return tmp_item


def openmm_Topology_and_molsysmt_StructuresDict_to_molsysmt_Topology(
    molecular_system, atom_indices="all", structure_indices="all", skip_digestion=False
):
    ...
    tmp_item = openmm_Topology_to_molsysmt_Topology(
        topology, atom_indices=atom_indices, skip_digestion=True
    )
