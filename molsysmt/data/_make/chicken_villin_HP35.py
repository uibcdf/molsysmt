...
shutil.move(
    "chicken_villin_HP35.h5msm", Path(data_dir, "h5msm/chicken_villin_HP35.h5msm")
)
...
shutil.move(
    ...
    Path(data_dir, "h5msm/chicken_villin_HP35_solvated.h5msm"),
)
...
simulation.reporters.append(
    app.DCDReporter(
        "traj_chicken_villin_HP35_solvated.dcd", 50000, enforcePeriodicBox=True
    )
)
simulation.reporters.append(HDF5Reporter("traj_chicken_villin_HP35_solvated.h5", 50000))
simulation.reporters.append(
    msm.thirds.openmm.reporters.H5MSMReporter(
        "traj_chicken_villin_HP35_solvated.h5msm", 10000000, 50000
    )
)
...
shutil.move(
    ...
    Path(data_dir, "dcd/traj_chicken_villin_HP35_solvated.dcd"),
)
shutil.move(
    "traj_chicken_villin_HP35_solvated.h5",
    Path(data_dir, "h5/traj_chicken_villin_HP35_solvated.h5"),
)
shutil.move(
    "traj_chicken_villin_HP35_solvated.h5msm",
    Path(data_dir, "h5msm/traj_chicken_villin_HP35_solvated.h5msm"),
)
