...
files_to_be_purged = ["trjpk/traj_two_lj_particles.trjpk"]
...
velocity = (
    np.zeros([n_saving_periods, 2, 3], np.float32) * unit.nanometers / unit.picosecond
)
