    ...
    if os.environ.get("MSM_VIEWS_FROM_HTML_FILES", "").lower() == "true":
        ...
        for frame_info in stack():
            ...
            if "nglview_htmlfile" in f_locals or "molsysviewer_htmlfile" in f_locals:
                htmlfile = f_locals.pop("nglview_htmlfile", None) or f_locals.pop(
                    "molsysviewer_htmlfile", None
                )
                break
        ...
        if resolved_path is not None:
            from molsysmt.third_party.nglview.load_html_in_jupyter_notebook import (
