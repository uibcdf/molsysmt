...
def test_get_mass_1():
    ...
    mass_atoms = msm.physchem.get_mass(
        molsys, element="atom", selection='molecule_type=="protein"'
    )
    mass_groups = msm.physchem.get_mass(
        molsys, element="group", selection='molecule_type=="protein"'
    )
    ...
    good_mass_atoms_1_10 = msm.pyunitwizard.quantity(
        [14.007, 12.011, 12.011, 15.999, 12.011, 12.011, 32.06, 12.011, 14.007, 12.011],
        unit="dalton",
    )
    good_mass_groups_1_10 = msm.pyunitwizard.quantity(
        [
            122.121,
            108.056,
            102.072,
...
def test_get_mass_2():
    ...
    mass_atoms = msm.physchem.get_mass(
        openmm_topology, element="atom", definition="OpenMM"
    )
    mass_groups = msm.physchem.get_mass(
        openmm_topology, element="group", definition="OpenMM"
    )
    mass_system = msm.physchem.get_mass(
        openmm_topology, element="system", definition="OpenMM"
    )
...
def test_get_mass_3():
    ...
    good_mass_atoms_1_10 = msm.pyunitwizard.quantity(
        [14.01, 12.01, 12.01, 16.0, 12.01, 12.01, 16.0, 14.01, 1.008, 1.008],
        unit="dalton",
    )
