...
def test_get_chain_type_1(hp35_solvated_molsys):
    ...
    output = msm.element.chain.get_chain_type(
        molsys, element="chain", selection="all", redefine_types=True
    )
...
def test_get_chain_type_2(hp35_solvated_molsys):
    ...
    msm.set(
        molsys, element="atom", selection="all", chain_index=[0], skip_digestion=True
    )
    msm.set(
        molsys,
        element="chain",
    ...
    molsys.topology.rebuild_chains(
