...
def test_get_component_name_1(hp35_solvated_molsys):
    ...
    output_t_t = msm.element.component.get_component_name(
        molsys,
        element="component",
        selection="all",
    ...
    output_t_f = msm.element.component.get_component_name(
        molsys,
        element="component",
        selection="all",
        redefine_indices=True,
    ...
    output_f_t = msm.element.component.get_component_name(
        molsys,
        element="component",
        selection="all",
    ...
    output_f_f = msm.element.component.get_component_name(
        molsys,
        element="component",
        selection="all",
        redefine_indices=False,
