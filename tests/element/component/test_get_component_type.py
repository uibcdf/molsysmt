...
def test_get_component_type_1(hp35_solvated_molsys):
    ...
    output_t_t = msm.element.component.get_component_type(
        molsys,
        element="component",
        selection="all",
    ...
    output_t_f = msm.element.component.get_component_type(
        molsys,
        element="component",
        selection="all",
        redefine_indices=True,
    ...
    output_f_t = msm.element.component.get_component_type(
        molsys,
        element="component",
        selection="all",
    ...
    output_f_f = msm.element.component.get_component_type(
        molsys,
        element="component",
        selection="all",
        redefine_indices=False,
    ...
    good_output = (
        ["peptide"]
        + ["water" for ii in range(n_waters)]
        + ["ion" for ii in range(n_ions)]
    )
