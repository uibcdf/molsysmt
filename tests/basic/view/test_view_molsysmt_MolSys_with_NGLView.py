...
def test_view_molsyst_MolSys_with_NLGView_1(t4_pdb_molsys):
    ...
    n_molecules, n_structures = msm.get(
        molsys, element="system", n_molecules=True, n_structures=True
    )
    n_molecules_2, n_structures_2 = msm.get(
        molsys_2, element="system", n_molecules=True, n_structures=True
    )
...
def test_view_molsyst_MolSys_with_NGLView_3(alanine_molsys):
    ...
    molsys_merged.topology.reset_chains(n_chains=1)
    msm.set(
        molsys_merged,
        element="atom",
        selection="all",
    ...
    molsys_merged.topology.rebuild_chains(
