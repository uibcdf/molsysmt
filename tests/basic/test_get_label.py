...
def test_get_label_1(tctim_h5msm_molsys):
...
def test_get_label_2(tctim_h5msm_molsys):
    molsys = tctim_h5msm_molsys
...
def test_get_label_3(tctim_h5msm_molsys):
    molsys = tctim_h5msm_molsys
    output = msm.get_label(
        molsys,
        element="atom",
        selection=10,
...
def test_get_label_4(tctim_h5msm_molsys):
    molsys = tctim_h5msm_molsys
...
def test_get_label_5(tctim_h5msm_molsys):
    molsys = tctim_h5msm_molsys
    output = msm.get_label(
        molsys,
        element="group",
...
def test_get_label_6(tctim_h5msm_molsys):
    molsys = tctim_h5msm_molsys
...
def test_get_label_7(tctim_h5msm_molsys):
    molsys = tctim_h5msm_molsys
    output = msm.get_label(
        molsys,
        element="component",
...
def test_get_label_8(tctim_h5msm_molsys):
    molsys = tctim_h5msm_molsys
...
def test_get_label_9(tctim_h5msm_molsys):
    molsys = tctim_h5msm_molsys
    output = msm.get_label(
        molsys,
        element="molecule",
...
def test_get_label_10(tctim_h5msm_molsys):
    molsys = tctim_h5msm_molsys
    output = msm.get_label(
        molsys, element="entity", selection=0, string="{entity_name}@{entity_index}"
    )
    true_output = "TRIOSEPHOSPHATE ISOMERASE@0"
    assert output == true_output
