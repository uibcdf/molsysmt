...
from molsysmt._private.argdigest.argument.center_at_origin import (
    digest_center_at_origin,
)
from molsysmt._private.argdigest.argument.center_coordinates import (
    digest_center_coordinates,
)
from molsysmt._private.argdigest.argument.center_of_atoms import digest_center_of_atoms
from molsysmt._private.argdigest.argument.center_of_atoms_2 import (
    digest_center_of_atoms_2,
)
from molsysmt._private.argdigest.argument.center_of_selection import (
    digest_center_of_selection,
)
...
def test_center_accepts_convert_semantics_and_alignment_bool():
    ...
    np.testing.assert_array_equal(
        digest_center(3, caller=caller), np.array([3], dtype="int64")
    )
    np.testing.assert_array_equal(
        digest_center([0, 2], caller=caller), np.array([0, 2], dtype="int64")
    )
