...
from molsysmt._private.argdigest.argument.color_values_scale import (
    digest_color_values_scale,
)
from molsysmt._private.argdigest.argument.color_values_scale_2 import (
    digest_color_values_scale_2,
)
...
def test_representation_is_caller_sensitive():
    assert (
        digest_representation(
            "cartoon", caller="molsysmt.third_party.nglview.add_representation"
        )
        == "cartoon"
    )
