...
from molsysmt._private.argdigest.argument.default_exclusion_rules import (
    digest_default_exclusion_rules,
)
from molsysmt._private.argdigest.argument.default_inclusion_rules import (
    digest_default_inclusion_rules,
)
from molsysmt._private.argdigest.argument.dispersion_correction import (
    digest_dispersion_correction,
)
from molsysmt._private.argdigest.argument.engine import digest_engine
from molsysmt._private.argdigest.argument.ewald_error_tolerance import (
    digest_ewald_error_tolerance,
)
...
from molsysmt._private.argdigest.argument.non_bonded_method import (
    digest_non_bonded_method,
)
...
def test_engine_and_mechanics_digesters():
    ...
    assert (
        digest_non_bonded_method(
            object(), caller="molsysmt.form.openmm_Topology.to_openmm_System"
        )
        is not None
    )
    ...
    assert (
        digest_rigid_water(
            True, caller="molsysmt.form.openmm_Topology.to_openmm_System"
        )
        is True
    )
