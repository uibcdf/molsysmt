...
def test_get_center_uses_canonical_coordinate_arrays_without_reextracting(monkeypatch):
    ...
    monkeypatch.setattr(
        get_center_module, "extract_coordinates_value_and_unit", _counting_helper
    )
