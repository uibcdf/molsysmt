...
def test_get_center_heavy_mode_flat_with_equal_weights_parity(
    pentalanine_molsys, pentalanine_h5msm
):
...
def test_get_center_heavy_mode_parity_groups(pentalanine_molsys, pentalanine_h5msm):
    ...
    list_groups = msm.get(
        pentalanine_molsys, element="group", selection="all", atom_index=True
    )
    structure_indices = [0, 100, 500]
...
def test_get_center_heavy_mode_groups_all_structures(
    pentalanine_molsys, pentalanine_h5msm
):
...
def test_get_center_heavy_mode_groups_with_equal_weights_parity(
    pentalanine_molsys, pentalanine_h5msm
):
