...
def test_align_principal_axes_molsysmt_MolSys_1():
    ...
    good_axes_1 = np.array(
        [
            [
                [0.09213962, -0.02624376, -0.9954002],
    ...
    molsys_2 = msm.structure.align_principal_axes(
        molsys, axes=[[1, 0, 0], [0, 1, 0], [0, 0, 1]]
    )

    axes_2, momenta_2 = msm.structure.get_principal_axes(molsys_2)

    good_axes_2 = np.array(
        [
            [
                [1.00000000e00, 2.87221485e-16, 8.58936055e-17],
                [-2.87221485e-16, 1.00000000e00, -3.60822483e-15],
                [-8.58936055e-17, 3.60822483e-15, 1.00000000e00],
            ]
        ]
    )
