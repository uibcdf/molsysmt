"""
Tests for molsysmt.config — covers module-level variables and the three
utility functions that configure pyunitwizard defaults.

Coverage target: molsysmt/config/__init__.py (33% → ~80%)
                 molsysmt/config/logging_setup.py (partially)
"""
...
class TestSetupLogging:
    ...
    def test_parse_level_int(self):
        ...
        import logging
        from molsysmt.config.logging_setup import _parse_level
