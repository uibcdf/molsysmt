...
def test_parity_n_atoms(topology_dict, source_topology):
    assert (
        msm.get(topology_dict, element="system", n_atoms=True)
...
def test_parity_n_groups(topology_dict, source_topology):
    assert (
        msm.get(topology_dict, element="system", n_groups=True)
...
def test_parity_n_chains(topology_dict, source_topology):
    assert (
        msm.get(topology_dict, element="system", n_chains=True)
...
def test_parity_n_bonds(topology_dict, source_topology):
    assert (
        msm.get(topology_dict, element="system", n_bonds=True)
...
def test_parity_atom_names(topology_dict, source_topology):
    assert (
        msm.get(topology_dict, element="atom", atom_name=True)
...
def test_parity_group_names(topology_dict, source_topology):
    assert (
        msm.get(topology_dict, element="group", group_name=True)
...
def test_parity_chain_ids(topology_dict, source_topology):
    assert (
        msm.get(topology_dict, element="chain", chain_id=True)
