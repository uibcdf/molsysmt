...
def test_file_pdb_to_molsysmt_structures_preserves_shape(
    md_1u19_pdb_file, md_1u19_pdb_molsys
):
...
def test_file_pdb_to_molsysmt_molsys_preserves_first_atom_names(
...
def test_file_pdb_from_builder_fixture_preserves_declared_truth(
    builder_pdb_molsys, builder_pdb_text, tmp_path
):
