...
def test_molsysmt_H5MSMFileHandler_to_molsysmt_topology_preserves_builder_counts(builder_h5msm_handler):
...
def test_molsysmt_H5MSMFileHandler_to_molsysmt_molsys_preserves_builder_names(builder_h5msm_handler):
...
def test_molsysmt_H5MSMFileHandler_to_molsysmt_molsys_preserves_builder_structure_metadata(builder_h5msm_handler):
    molsys = msm.convert(builder_h5msm_handler, to_form='molsysmt.MolSys')
