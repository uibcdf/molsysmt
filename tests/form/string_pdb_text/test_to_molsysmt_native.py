...
def test_string_pdb_text_to_molsysmt_topology_preserves_counts(
    t4_pdb_text, t4_pdb_molsys
):
...
def test_written_string_pdb_text_to_molsysmt_molsys_preserves_names(
    t4_written_pdb_text, t4_pdb_molsys
):
...
def test_string_pdb_text_to_molsysmt_structures_preserves_multimodel_shape(
    md_1u19_pdb_text, md_1u19_pdb_molsys
):
...
def test_string_pdb_text_from_builder_fixture_preserves_declared_truth(
    builder_pdb_text, builder_pdb_molsys
):
