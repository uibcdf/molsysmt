...
def test_openmm_topology_to_molsysmt_topology_preserves_builder_counts(
    builder_openmm_topology,
):
...
def test_openmm_topology_to_molsysmt_molsys_preserves_declared_atom_group_and_chain_names(
    builder_openmm_topology,
):
...
def test_openmm_topology_to_molsysmt_molsys_rebuilds_lossy_molecule_and_entity_metadata(
    builder_openmm_topology,
):
    molsys = msm.convert(builder_openmm_topology, to_form="molsysmt.MolSys")
