...
| Pentaalanine | `molsysmt/data/h5msm/traj_pentalanine.h5msm` | Paired MolSysMT H5MSM 0.4 trajectory artifact | `d882572a520fe0cb7dbd4c3254e8f38171d4c788d739ab81ee387acd495433b6` |
...
The pentaalanine H5MSM artifact was migrated without changing its scientific arrays
from the legacy H5MSM 0.3 input whose SHA-256 is
`3eda9e887845b27073a498ae2d6e564596abbe52d1cbdca76870dd23fd98a285`.
That input checksum remains in `molsysmt/data/demo_manifest.json` as
`source_sha256`; it is not the checksum of the migrated H5MSM 0.4 artifact above.
