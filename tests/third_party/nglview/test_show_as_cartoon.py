...
def test_show_as_cartoon_1():
    ...
    selection = msm.select(
        molsys, selection="group_index in [5,6,7,8,9,10]", to_syntax="NGLview"
    )
...
def test_show_as_cartoon_2():
    ...
    msm.thirds.nglview.show_as_cartoon(
        view, selection="group_index in [5,6,7,8,9,10]", color="purple"
    )
