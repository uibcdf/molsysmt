...
def test_solvate_molsysmt_MolSys_1():
    ...
    n_waters, box_shape, n_ions = msm.get(
        molsys, element="system", n_waters=True, box_shape=True, n_ions=True
    )
    assert n_waters > 400
...
def test_solvate_molsysmt_MolSys_2():
    ...
    n_waters, box_shape = msm.get(
        molsys, element="system", n_waters=True, box_shape=True
    )
    assert n_waters > 400
