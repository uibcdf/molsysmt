...
def test_supported_1():
    ...
    good_df_data = set([
        ...
        ('molsysmt.MolSysDict', 'class'),
        ('molsysmt.TopologyDict', 'class'),
        ...
        ('file:h5msm', 'file'),
        ('file:inpcrd', 'file'),
        ('file:molsys_yaml', 'file'),
        ('file:topology_yaml', 'file'),
        ('file:structures_yaml', 'file'),
        ('file:mmtf', 'file'),
        ('file:mol2', 'file'),
        ('file:msmpk', 'file'),
        ('file:pdb', 'file'),
...
def test_supported_2():
    ...
    good_aux_list = ['biopython.Seq', 'biopython.SeqRecord',
                     ...
                     'file:h5msm', 'file:inpcrd', 'file:mmtf', 'file:mol2', 'file:molsys_yaml', 'file:topology_yaml', 'file:structures_yaml', 'file:msmpk', 'file:pdb',
                     ...
                     'molsysmt.StructuresDict', 'molsysmt.Topology', 'molsysmt.ViewerJSON', 'molsysviewer.MolSysView', 'networkx.Graph',
                     ...
                     'string:pdb_text', 'XYZ', 'cupy_ndarray',
