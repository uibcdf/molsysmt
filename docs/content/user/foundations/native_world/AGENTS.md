# Section 03: The Native World Directives (`AGENTS.md`)

This guide governs all content under `docs/content/user/foundations/native_world/`.

## 🧭 Subdirectory Purpose & Scope
Cover native MolSysMT objects and formats: `molsysmt.MolSys`, `molsysmt.Topology`, native H5MSM file format, and `molsysmt.ViewerJSON`.
