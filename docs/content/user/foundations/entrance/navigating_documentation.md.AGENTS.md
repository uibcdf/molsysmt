...
3. **Inviolable Navigation Scenarios**:
   - **5-Minute Quickstart**: Links to `../../../showcase/quickstart`.
   - **Core Concepts (Foundations)**: Overview of the 8 Foundations sections.
   - **Tools API**: Overview of API functional modules (Basic, Build, Structure, Topology, Elements, Third Party).
