...
The MolSysMT documentation is organized into complementary sections designed to support users at every stage of their workflow — whether you have five minutes to test a quick script or are building complex computational pipelines.

Rather than forcing a rigid linear reading order, this guide helps you choose the most effective path for your current goal.
...
If you want an immediate hands-on feeling for MolSysMT, skip directly to the interactive **Quickstart Guide** in the Showcase section:
...
### If you want to understand the core concepts
If you are starting a new research project or want to understand *why* MolSysMT behaves the way it does, explore the **Foundations** section step by step:
...
### If you are looking for a specific tool or function
...
### If you need real-world workflow recipes
...
### If you prefer a comprehensive academic course
...
### If you want advanced examples and third-party integrations
