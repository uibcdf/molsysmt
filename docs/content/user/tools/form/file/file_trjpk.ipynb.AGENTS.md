# Micro-Governance: file_trjpk.ipynb

## Purpose
Governance rules and frozen contracts for `/home/diego/repos@uibcdf/molsysmt/docs/content/user/tools/form/file/file_trjpk.ipynb` (`file:trjpk`).
