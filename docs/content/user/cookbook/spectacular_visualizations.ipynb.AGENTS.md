# Micro-Governance: spectacular_visualizations.ipynb

## Purpose
Governance rules, frozen contracts, and testing requirements for `spectacular_visualizations.ipynb`.

## Inviolable Rules & Contracts
1. **Header Block**: Must begin with anchor `(Cookbook_Spectacular_Visualizations)=`, title `# Working with NGLView`, gerund summary, and `:::{versionadded} 1.0.0::: `.
