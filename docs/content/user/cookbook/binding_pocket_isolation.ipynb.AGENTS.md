# Micro-Governance: binding_pocket_isolation.ipynb

## Purpose
Governance rules, frozen contracts, and testing requirements for `binding_pocket_isolation.ipynb`.

## Inviolable Rules & Contracts
1. **Header Block**: Must begin with anchor `(Cookbook_Binding_Pocket_Isolation)=`, title `# Binding Pocket Isolation`, gerund summary, and `:::{versionadded} 1.0.0::: `.
