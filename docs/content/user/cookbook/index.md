...
Each recipe is designed to be a "Superpower": a self-contained solution to a real-world scientific problem.
...
*   [**Trajectory Performance Analysis**](./07_Trajectory_Performance_Analysis.ipynb): Calculating stability (RMSD) for thousands of frames in record time.
*   [**Big Data Trajectories**](./04_Big_Data_Trajectories.ipynb): Handling massive H5MSM files with ultra-low latency.

### 🎨 Interaction & Visualization
*   [**Spectacular Visualizations**](./02_Spectacular_Visualizations.ipynb): Mastering NGLView and MolSysViewer for publication-quality renders.
*   [**Form Teleportation**](./09_Form_Teleportation.ipynb): Bridging MolSysMT with OpenMM, MDAnalysis, NetworkX, and BioPython.
