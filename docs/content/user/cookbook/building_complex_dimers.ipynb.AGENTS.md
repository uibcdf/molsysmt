# Micro-Governance: building_complex_dimers.ipynb

## Purpose
Governance rules, frozen contracts, and testing requirements for `building_complex_dimers.ipynb`.

## Inviolable Rules & Contracts
1. **Header Block**: Must begin with anchor `(Cookbook_Building_Complex_Dimers)=`, title `# Building Complex Dimers`, gerund summary, and `:::{versionadded} 1.0.0::: `.
