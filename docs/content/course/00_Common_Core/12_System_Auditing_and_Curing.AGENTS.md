# Module 12 Content Governance (`12_System_Auditing_and_Curing.AGENTS.md`)

This document defines the **non-negotiable content contract** for `12_System_Auditing_and_Curing.ipynb`. 
