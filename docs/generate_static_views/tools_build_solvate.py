...
molsys1_cub = msm.pbc.wrap_to_pbc(
    molsys1_cub, center_of_selection='molecule_type=="peptide"'
)
...
molsys1_oct = msm.build.solvate(
    molsys1, box_shape="truncated octahedral", clearance="14.0 angstroms"
)
molsys1_oct = msm.pbc.wrap_to_pbc(
    molsys1_oct, center_of_selection='molecule_type=="peptide"'
)
