...
molsys2 = msm.build.add_missing_terminal_cappings(
    molsys2, N_terminal="ACE", C_terminal="NME"
)
molsys2 = msm.structure.center(molsys2)
molsys2 = msm.build.solvate(
    molsys2, box_shape="truncated octahedral", clearance="14.0 angstroms"
)
