...
view = msm.view(molsys_D)
view.export.html(str(views_dir / "tools_basic_merge.html"), shared_runtime=str(static_dir), background="transparent")
print("Successfully generated tools_basic_merge.html")
