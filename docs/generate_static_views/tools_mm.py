...
view1.export.html(
    str(views_dir / "tools_mm_get_forces_1.html"), background="transparent"
)
...
molsys_dimer = msm.convert(
    msm.systems["Barnase-Barstar"]["1brs.h5msm"], to_form="molsysmt.MolSys"
)
view2 = msm.view(molsys_dimer)
view2.export.html(
    str(views_dir / "tools_mm_get_non_bonded_potential_energy_1.html"),
