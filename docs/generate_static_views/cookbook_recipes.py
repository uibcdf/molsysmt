...
view.export.html(
    str(views_dir / "cookbook_binding_pocket.html"), background="transparent"
)
...
view.export.html(
    str(views_dir / "cookbook_dimers_initial.html"), background="transparent"
)
...
barstar_aligned = msm.structure.least_rmsd_align(
    barstar_best, selection='atom_name=="CA"', reference_molecular_system=barstar_ref
)
view = msm.view([barnase, barstar_aligned])
view.export.html(
    str(views_dir / "cookbook_dimers_aligned.html"), background="transparent"
)
...
view = msm.view(dimer)
view.export.html(
    str(views_dir / "cookbook_dimers_final.html"), background="transparent"
)
...
view.export.html(
    str(views_dir / "cookbook_solvated_box.html"), background="transparent"
)
...
view.export.html(
    str(views_dir / "cookbook_mutagenesis_mutant.html"), background="transparent"
)
...
view = msm.view(solvated_molsys)
view.export.html(
    str(views_dir / "cookbook_simulation_solvated.html"), background="transparent"
)
