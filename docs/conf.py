...
# release = molsysmt.__version__ # Uncomment this to include alpha/beta/rc and git tags
release = molsysmt.__version__.split("+")[0]
...
def setup(app):
    ...
    app.add_js_file(
        "https://cdn.jsdelivr.net/npm/nglview-js-widgets@3.1.0/dist/index.js"
    )
