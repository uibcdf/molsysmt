...
from molsysmt._private.topology_expansion import expand_atom_dataframe  # noqa: E402
from molsysmt.native import Topology  # noqa: E402
...
def _build_topology(n_atoms=100_000):
    ...
    topology.entities["entity_name"] = [
        f"entity {index}" for index in range(n_entities)
    ]
