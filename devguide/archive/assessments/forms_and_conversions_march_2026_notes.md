...
> **Archived implementation notes:** Adapter inventories, fixes, counts, and
> status claims below describe a March 2026 development pass. Consult the active
> `devguide/forms_and_conversions.md` for the current contract.
