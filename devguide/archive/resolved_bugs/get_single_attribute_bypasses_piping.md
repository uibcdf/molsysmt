...
> diagnosed; current behavior is defined by code and regression tests.

**Status:** resolved 2026-07-13
**Severity:** high — affects Tier 1 forms through the public `get()` facade
**Implementation:** `molsysmt/basic/get.py`, `_piped_molecular_system()`
**Regression tests:** `tests/basic/get/test_piped_attributes.py` and
...
## Related issue retained separately
