...
- [release_and_citation.md](release_and_citation.md) — GitHub Release, Zenodo,
  concept/version DOI, citation metadata, and post-release verification contract.
...
- [Documentation bugs](pending_bugs/docs/README.md) and
  [documentation proposals](pending_proposals/docs/README.md) contain the same two
  kinds of entry for work whose deliverable is user-facing documentation rather
  than code.
