# Bug: `merge` cannot receive per-system indices, the documented form crashes
...
The docstring of `merge` should be re-read against whatever is implemented: today it promises
