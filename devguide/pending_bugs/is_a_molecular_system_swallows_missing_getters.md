# Bug: `is_a_molecular_system` turns a missing getter into a valid system

**Status:** pending (diagnosed 2026-07-12; the `file:inpcrd` trigger is fixed, the
predicate itself is not)
