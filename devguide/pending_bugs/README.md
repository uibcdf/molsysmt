...
- [`windows_import_of_molsysmt_configure_uses_posix_sysconf.md`](windows_import_of_molsysmt_configure_uses_posix_sysconf.md) — [#239](https://github.com/uibcdf/molsysmt/issues/239) — Windows import of molsysmt.configure fails because os.sysconf is unavailable *(high, reproduced)*
